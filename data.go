...
func init() {
	characterNameMap = map[int]interface{}{
		...
		1112: []string{"禊(万圣节)", "ミソギ(ハロウィン)", "mcw", "万圣禊", "万圣炸弹人", "瓜炸弹人", "万圣炸弹", "万圣炸", "瓜炸", "南瓜炸", "🎃💣"},
		1113: []string{"美美(万圣节)", "ミミ(ハロウィン)", "Mimi(Halloween)", "万圣兔", "万圣兔子", "万圣兔兔", "绷带兔", "绷带兔子", "万圣美美", "绷带美美", "万圣🐰", "绷带🐰", "🎃🐰", "万圣🐇", "绷带🐇", "🎃🐇"},
		1114: []string{"露娜", "ルナ", "Runa", "xcw", "露仓唯", "露cw"},
		...
		1118: []string{"佩可莉姆(新年)", "春吃", "新年佩可", "新年贪吃佩可"},
		...
		1142: []string{"莫妮卡(魔法少女)", "魔法少女莫妮卡", "魔二力"},
		1143: []string{"智(魔法少女)", "魔法少女智", "琪露诺"},
		1144: []string{"秋乃(圣诞节)", "圣诞秋乃", "圣诞哈哈剑", "圣哈"},
		1145: []string{"咲恋(圣诞节", "圣诞充电宝", "圣电"},
		1146: []string{"优花梨(圣诞节)", "圣诞黄骑", "圣黄", "圣骑"},
		1147: []string{"矛依未(新年)", "矛依未", "春511"},
		1150: []string{"似似花(新年)", "春448", "春nnk", "春妃"},
